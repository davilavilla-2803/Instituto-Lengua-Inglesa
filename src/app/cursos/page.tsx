...
export default function CursosPage() {
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="py-32 bg-brandAccentDark relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brandAccent rounded-full blur-[150px]" />
        </div>

        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="glass p-12 md:p-20 rounded-[3.5rem] border-white/5 bg-white/5 backdrop-blur-3xl overflow-hidden relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brandAccent/10 text-brandAccent text-[10px] font-black uppercase tracking-widest border border-brandAccent/20">
                  ¿No sabés por dónde empezar?
                </span>
                <h2 className="text-4xl md:text-6xl font-bold text-white font-display tracking-tight leading-tight">
                  Conocé tu nivel <br />
                  <span className="text-brandPrimary">gratis</span>
                </h2>
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute -inset-4 bg-brandAccent/20 rounded-full blur-3xl" />
                <div className="relative p-12 bg-white rounded-[2.5rem] text-center shadow-2xl">
                  <div className="w-20 h-20 bg-brandPrimary/50 rounded-2xl flex items-center justify-center text-brandAccent mx-auto mb-8 shadow-sm">
                    <Zap size={40} />
                  </div>
                  ...
                  <a
                    ...
                    className="w-full h-16 inline-flex items-center justify-center bg-brandAccentDark text-white rounded-full font-black uppercase tracking-[0.2em] text-[10px] shadow-xl hover:scale-105 transition-all group"
                  >
