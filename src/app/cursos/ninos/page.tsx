...
export default function CursoNinosPage() {
  return (
    <div className="flex flex-col bg-white">
      <PageHero
        label="Cursos — Niños"
        title="Inglés para <span class='text-gradient'>los más chicos</span>"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-typographyMain font-display tracking-tight leading-tight">
                Una experiencia <span className="text-gradient">divertida y estimulante</span>
              </h2>
      ...
      <section className="py-32 bg-brandAccentDark text-white text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <div className="absolute top-0 left-0 w-96 h-96 bg-brandAccent rounded-full blur-[150px]" />
        </div>
        
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          <p className="text-[10px] font-black tracking-[0.4em] uppercase text-brandAccent mb-8 block">¿Tu hijo/a está listo?</p>
          <h2 className="text-4xl md:text-6xl font-bold font-display tracking-tight mb-12">Impulsá su futuro <span className="text-brandPrimary">bilingüe</span></h2>
