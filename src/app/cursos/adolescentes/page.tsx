  ...
  return (
    <div className="flex flex-col bg-white">
      <PageHero
        ...
        title="Inglés para <span class='text-gradient'>Adolescentes</span>"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div 
              ...
              className="space-y-8"
            >
              <span className="text-[10px] font-black tracking-[0.4em] uppercase text-brandAccent block">A partir de los 13 años</span>
      ...
      <section className="py-32 bg-brandAccentDark text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 relative z-10">
          <p className="text-[10px] font-black tracking-[0.4em] uppercase text-brandAccent mb-8 block">¿Todo listo para empezar?</p>
          <h2 className="text-4xl md:text-6xl font-bold font-display tracking-tight mb-12">Desafiá su <span className="text-brandPrimary">potencial</span></h2>
